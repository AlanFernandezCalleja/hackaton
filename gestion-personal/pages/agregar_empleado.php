            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <h4 class="mb-0"><i class="fas fa-user-plus me-2"></i>Agregar Nuevo Empleado</h4>
                    </div>
                    <div class="card-body">
                        <?php if (isset($error)): ?>
                        ...
                        <form method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="tiempo_prueba" name="tiempo_prueba" required>
                            </div>
